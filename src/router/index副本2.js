...
export const constantRouterMap = [
  ...
  // 营销管理
  {
    ...
    children: [
      { path: 'grouponIndex', component: _import('groupon/index'), name: 'groupon', hidden: true, meta: { title: 'groupon', icon: 'component', noCache: true }}, // 团购活动
      { path: 'cutGroupIndex', component: _import('cutGroup/index'), name: 'cutGroup', hidden: true, meta: { title: 'cutGroup', icon: 'component', noCache: true }}, // 拼团活动
      { path: 'bargainIndex', component: _import('bargain/index'), name: 'bargain', hidden: true, meta: { title: 'bargain', icon: 'component', noCache: true }}, // 砍价活动
      { path: 'voteIndex', component: _import('vote/index'), name: 'vote', hidden: true, meta: { title: 'vote', icon: 'component', noCache: true }}, // 投票活动
      { path: 'seckillIndex', component: _import('seckill/index'), name: 'seckill', hidden: true, meta: { title: 'seckill', icon: 'component', noCache: true }}, // 爆款秒杀
      { path: 'redsplitIndex', component: _import('redsplit/index'), name: 'redsplit', hidden: true, meta: { title: 'redsplit', icon: 'component', noCache: true }}, // 红包裂变
      ...
      { path: 'redPackageIndex', component: _import('redPackage/index'), name: 'redPackage', meta: { title: 'redPackage', icon: 'component', noCache: true }}, // 分享红包
