...
<script>
  import { addMaterial } from '@/api/secKill'
  import { genQrcode } from '@/api/secKill'
  import UploadImg from '../../components/UploadImg'
  import UploadMusic from '../../components/UploadMusic'
  import { getToken } from '@/utils/auth'
  import { detailMaterial } from '@/api/secKill'
    ...
    methods: {
      ...
      save() {
        ...
        addMaterial(this.saveUrl)
          .then((result) => {
            result ? this.$router.push({ name: 'duckIconSeckill', query: { activity_id: this.saveUrl.activity_id }}) : ''
          })
      },
      // 拿到活动介绍的图片
      getImg11(data) {
