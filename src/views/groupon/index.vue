    ...
    <el-main>
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <span>团购活动列表</span>
          <el-button style="float: right; padding: 3px 0" type="text" @click="addGroupActivity">添加团购活动</el-button>
        </div>
        <div>
          <el-table :data="GroupActiveList" border style="width: 100%">
            <el-table-column prop="createtime" label="创建时间" width="200"></el-table-column>
            <el-table-column prop="name" label="团购活动标题" width="300"></el-table-column>
            ...
            <el-table-column prop="view_num" label="浏览量" width="100"></el-table-column>
            <el-table-column prop="people_num" label="已参团人数" width="100"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addGroupActivity() {
        this.$router.push({ name: 'addGroupon' })
      },
      filterTag(value, row) {
        console.log(12)
